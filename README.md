...
## The Keyboard Ayatana System Indicator

The -keyboard Ayatana System Indicator is the keyboard menu indicator for
Unity7, MATE and Lomiri (optionally for others, e.g. XFCE, LXDE). Its
behavior and features are listed at
https://wiki.ayatana-indicators.org/AyatanaIndicatorKeyboard
